...
if __name__ == "__main__":
    ...
    # set manager
    manager: MLManager = MLManager(dataset.metadata.columns_feature, dataset.metadata.columns_target, is_reg=True, n_jobs=8)
    # pre processing
    ...
    manager.fit(
        ...
        params_fit={"loss_func": "reg", "num_iterations": 200, "x_valid": "_validation_x", "y_valid": "_validation_y"}
    )
    ...
    manager.fit_cross_validation(
        ...
        params_fit_evaldict={
            "loss_func": "reg", "num_iterations": 100, "loss_func_eval": "reg",
